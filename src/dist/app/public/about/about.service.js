...
let AboutService = class AboutService {
     ...
     */
    getAbout() {
        return this.http.get(`${this.globalService.baseurl}/about`).pipe(operators_1.map((res) => {
            this.about = res['data'];
            return this.about;
        }), operators_1.tap(_ => this.globalService.log('fetched about')), operators_1.catchError(this.globalService.handleError('getAbout', [])));
    }
};
